...
export const Chat = () => {
  ...
  return (
  <div className="w-full min-h-screen flex items-center justify-center bg-black p-0 sm:p-4">
    <div className="w-full h-screen sm:w-[90%] sm:h-[90vh] md:w-[700px] lg:w-[900px] bg-[#EDF0F6] flex flex-col justify-between rounded-none sm:rounded-2xl shadow-md overflow-hidden">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 p-4 border-b border-[#B5B5B5]">
        ...
        {chat.map((msg, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`max-w-[80%] sm:max-w-[60%] rounded-lg p-3 text-sm sm:text-base break-words ${
                  msg.name === name
                    ? "bg-[#D0D4E7]"
